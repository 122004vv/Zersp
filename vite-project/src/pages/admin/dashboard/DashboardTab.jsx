...
function DashboardTab() {
  ...
  const { mode, allProducts, deleteProduct, order, user } = context;
          ...
          <Tabs defaultIndex={0} className=" ">
            <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
              <Tab>
                <button
                  type="button"
                  className="font-medium border-b-2 hover:shadow-[#500724]-700 border-[#500724]-500 text-[#500724]-500 rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]  px-5 py-1.5 text-center bg-[#605d5d12] "
                >
              ...
              <Tab>
                <button
                  type="button"
                  className="font-medium border-b-2 border-[#500724]-500 bg-[#605d5d12] text-[#500724]-500  hover:shadow-[#500724]-700  rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]    px-5 py-1.5 text-center "
                >
                  <div className="flex gap-2 items-center">
              ...
              <Tab>
                <button
                  type="button"
                  className="font-medium border-b-2 border-[#500724]-500 bg-[#605d5d12] text-[#500724]-500 rounded-lg text-xl  hover:shadow-[#500724]-700 shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]   px-5 py-1.5 text-center "
                >
                  <div className="flex gap-2 items-center">
                    <FaUser /> Users
                  </div>
